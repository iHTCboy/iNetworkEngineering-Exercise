...
/**
 * 简单的基于UDP的一对一聊天程序，支持GUI。本类提供服务器端功能。
 * 
 * @author (YHZ) 
 * @version (2013-6-27)
 */
...
public class UDPChatServer extends JFrame implements ActionListener  //继承JFrame，并实现ActionListener
{
    //以下是GUI相关的一些控件定义
    private JTextField rcvPortField = new JTextField("   6060   ");   //接收端口文本框
    private JTextField sendPortField = new JTextField("   5050   ");   //发送端口文本框
