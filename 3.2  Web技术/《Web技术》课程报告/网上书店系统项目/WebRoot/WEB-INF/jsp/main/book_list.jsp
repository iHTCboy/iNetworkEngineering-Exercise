								...
								<s:if test="category.id==id">
									<li>
										<div>
											...
											<div class=second_fenlei>
												<a
													href="${pageContext.request.contextPath}/main/bookListAction?category.id=${id}&category.parentId=${parentId} "
							...
							<s:if test="page.pageNo>1">
								<div class='list_r_title_text3a'>
									<a name=link_page_next
										href="${pageContext.request.contextPath}/main/bookListAction?category.id=${category.id}&category.parentId=${category.parentId}&page.pageNo=${page.pageNo-1}">
										<img
					...
					<s:iterator value="books">
						<div class="list_r_list">
							...
							<h6>
								...
								<span class="red">￥<s:property value="dangPrice"/></span> 节省：￥<s:property value="fixedPrice-dangPrice"/>
							</h6>
							<span class="list_r_list_button"> <a href="${pageContext.request.contextPath}/cart/buyAction?id=${id}"> <img
