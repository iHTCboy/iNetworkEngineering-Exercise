...
string ** GetMaze(int &m,int &n);       //获取迷宫
//返回存取迷宫的二维指针
int main()
{
...
string ** GetMaze(int &m,int &n)//返回存取迷宫的二维指针
{
 ...
 m=a;
 n=b;          //m,n分别代表迷宫的行数和列数
 maze=new  string *[m+2];  //申请长度等于行数加2的二级指针
